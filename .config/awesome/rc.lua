...
globalkeys = gears.table.join(
    ...
    awful.key({}, "XF86AudioRaiseVolume",
        function()
            local command = "pulsemixer --change-volume +5 --max-volume 100"
            awful.spawn.easy_async_with_shell(command, function() beautiful.volume.update() end)
        end,
    ...
    awful.key({}, "XF86AudioMute",
        function()
            local command = "pulsemixer --toggle-mute"
            awful.spawn.easy_async_with_shell(command, function() beautiful.volume.update() end)
        end,
