...
local fullnotification = false
    ...
    bat_notification_critical_preset = { ---@diagnostic disable-line
    ...
    bat_notification_low_preset = { ---@diagnostic disable-line
        title   = "Battery low",
        text    = "Plug the cable!",
        timeout = 15,
        fg      = "#202020",
    ...
    bat_notification_charged_preset = { ---@diagnostic disable-line
        title   = "Battery full",
...
function Battery:new(args)
    local b = {}
    b.pspath = args.pspath or "/sys/class/power_supply/"
    b.widget = args.widget or { layout = wibox.container.background, { widget = wibox.widget.textbox, id = "text" } }
